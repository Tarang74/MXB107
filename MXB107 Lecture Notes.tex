...
\begin{center}
    ...
    \end{tabular}
\end{center}
where \(Z_{p}\) refers to the upper tail probability of the standard normal distribution,
and \(Z_{-p}\) refers to the lower tail probability of the standard normal distribution:
\begin{align*}
    \Pr{\left( Z \geq Z_{\alpha / 2} \right)} & = \frac{\alpha}{2} \\
